    ...
    laws: [
      {
        ...
        governs: {
          ...
          te: ["రుణ ఒప్పందాలు", "బ్యాంకింగ్ కాంట్రాక్టులు", "క్రెడిట్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.17", title: "Business RBI may transact", detail: "Defines what financial operations the RBI can conduct — sets the foundation for all bank regulation." },
          { section: "S.21", title: "RBI as banker to Government", detail: "RBI manages government accounts — relevant in contracts involving government-backed financial schemes." },
          { section: "S.42", title: "Cash Reserve Ratio", detail: "Banks must maintain a minimum cash reserve. Contracts that promise interest rates conflicting with CRR-linked rates may be unenforceable." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Bank account agreements", "Fixed deposit contracts", "Loan agreements"],
          hi: ["बैंक खाता समझौते", "सावधि जमा अनुबंध", "ऋण समझौते"],
          te: ["బ్యాంక్ ఖాతా ఒప్పందాలు", "స్థిర డిపాజిట్ కాంట్రాక్టులు", "రుణ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.6", title: "Forms of business banks may carry on", detail: "Banks cannot engage in businesses outside the permitted scope." },
          { section: "S.22", title: "Licensing of banks", detail: "Only licensed banks can accept deposits — protects you from unlicensed entities." },
          { section: "S.35A", title: "Power of RBI to give directions", detail: "RBI can override any bank policy — bank contracts cannot override RBI directives." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["International contracts", "Foreign investment agreements", "Export/import contracts"],
          hi: ["अंतर्राष्ट्रीय अनुबंध", "विदेशी निवेश समझौते", "निर्यात/आयात अनुबंध"],
          te: ["అంతర్జాతీయ కాంట్రాక్టులు", "విదేశీ పెట్టుబడి ఒప్పందాలు", "ఎగుమతి/దిగుమతి కాంట్రాక్టులు"]
        },
        keySections: [
          { section: "S.3", title: "Dealing in foreign exchange", detail: "No person shall deal in foreign exchange without RBI authorisation." },
          { section: "S.6", title: "Capital account transactions", detail: "Regulates investments and transfers abroad." },
          { section: "S.13", title: "Penalties", detail: "Up to 3 times the amount involved or ₹2 lakh, whichever is higher." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Investment agreements", "Broker contracts", "Mutual fund terms"],
          hi: ["निवेश समझौते", "ब्रोकर अनुबंध", "म्यूचुअल फंड शर्तें"],
          te: ["పెట్టుబడి ఒప్పందాలు", "బ్రోకర్ కాంట్రాక్టులు", "మ్యూచువల్ ఫండ్ నిబంధనలు"]
        },
        keySections: [
          { section: "S.11", title: "Functions of SEBI", detail: "SEBI can regulate stock exchanges and protect investor interests." },
          { section: "S.12A", title: "Prohibition of manipulative practices", detail: "Clauses promising guaranteed returns on securities are illegal." },
          { section: "S.15G", title: "Penalty for insider trading", detail: "₹25 crore or 3x profits, whichever is higher." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Loan agreements", "Business contracts", "Debt restructuring documents"],
          hi: ["ऋण समझौते", "व्यापार अनुबंध", "ऋण पुनर्गठन दस्तावेज"],
          te: ["రుణ ఒప్పందాలు", "వ్యాపార కాంట్రాక్టులు", "అప్పు పునర్వ్యవస్థీకరణ పత్రాలు"]
        },
        keySections: [
          { section: "S.7", title: "Initiation by financial creditor", detail: "A creditor can drag a debtor to NCLT if they default on ₹1 crore or more." },
          { section: "S.14", title: "Moratorium", detail: "Once insolvency begins, all proceedings against the debtor are frozen." },
          { section: "S.96", title: "Interim moratorium for individuals", detail: "Individuals can also get protection under IBC from creditor harassment." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Home loan agreements", "Business loan agreements", "Mortgage deeds"],
          hi: ["गृह ऋण समझौते", "व्यापार ऋण समझौते", "बंधक विलेख"],
          te: ["గృహ రుణ ఒప్పందాలు", "వ్యాపార రుణ ఒప్పందాలు", "తనఖా దస్తావేజులు"]
        },
        keySections: [
          { section: "S.13(2)", title: "60-day notice", detail: "Bank must give 60 days notice before taking action — after that, they can act without court order." },
          { section: "S.13(4)", title: "Measures after notice period", detail: "Bank can take possession, manage, and sell secured assets without court intervention." },
          { section: "S.17", title: "Right to appeal", detail: "Borrower can appeal to the Debt Recovery Tribunal within 30 days." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Bank account agreements", "Investment contracts", "Real estate purchase agreements"],
          hi: ["बैंक खाता समझौते", "निवेश अनुबंध", "रियल एस्टेट खरीद समझौते"],
          te: ["బ్యాంక్ ఖాతా ఒప్పందాలు", "పెట్టుబడి కాంట్రాక్టులు", "రియల్ ఎస్టేట్ కొనుగోలు ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.3", title: "Offence of money laundering", detail: "Anyone involved in a transaction with proceeds of crime is guilty — even if they didn't commit the crime." },
          { section: "S.12", title: "Obligations of banking companies", detail: "Banks must verify identity (KYC), keep records for 5 years, and report suspicious transactions." },
          { section: "S.19", title: "Power to arrest", detail: "ED officers can arrest without warrant if they believe a PMLA offence is being committed." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Loan agreements (post-dated cheques)", "Business contracts", "Rental agreements (security cheques)"],
          hi: ["ऋण समझौते (पोस्ट-डेटेड चेक)", "व्यापार अनुबंध", "किराया समझौते (सुरक्षा चेक)"],
          te: ["రుణ ఒప్పందాలు (పోస్ట్-డేటెడ్ చెక్కులు)", "వ్యాపార కాంట్రాక్టులు", "అద్దె ఒప్పందాలు (భద్రత చెక్కులు)"]
        },
        keySections: [
          { section: "S.138", title: "Dishonour of cheque", detail: "Bouncing a cheque is a CRIMINAL offence — imprisonment up to 2 years or fine up to 2x cheque amount." },
          { section: "S.139", title: "Presumption", detail: "Court presumes the cheque was issued for a legal debt — burden is on the accused to prove otherwise." },
          { section: "S.142", title: "Cognizance of offences", detail: "Complaint must be filed within 30 days of dishonour notice." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Fintech agreements", "Payment gateway contracts", "Digital wallet agreements"],
          hi: ["फिनटेक समझौते", "पेमेंट गेटवे अनुबंध", "डिजिटल वॉलेट समझौते"],
          te: ["ఫిన్‌టెక్ ఒప్పందాలు", "పేమెంట్ గేట్‌వే కాంట్రాక్టులు", "డిజిటల్ వాలెట్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.18", title: "Power to call for information", detail: "RBI can inspect and audit any payment system operator." },
          { section: "S.26", title: "Penalties", detail: "Up to ₹10 lakh per day for operating without authorisation." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Life insurance policies", "Health insurance contracts", "Motor insurance", "Home insurance"],
          hi: ["जीवन बीमा पॉलिसी", "स्वास्थ्य बीमा अनुबंध", "वाहन बीमा", "गृह बीमा"],
          te: ["జీవిత బీమా పాలసీలు", "ఆరోగ్య బీమా కాంట్రాక్టులు", "వాహన బీమా", "గృహ బీమా"]
        },
        keySections: [
          { section: "S.45", title: "Policy not questioned after 3 years", detail: "After 3 years, insurer cannot reject a claim on grounds of misrepresentation (except fraud)." },
          { section: "S.64VB", title: "No risk before premium payment", detail: "Risk only commences after premium is received." },
          { section: "IRDAI Regulations", title: "Claim settlement timelines", detail: "Insurers must settle claims within 30 days of receiving all documents." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["All contracts", "Employment agreements", "Service contracts", "NDAs"],
          hi: ["सभी अनुबंध", "रोजगार समझौते", "सेवा अनुबंध", "NDA"],
          te: ["అన్ని కాంట్రాక్టులు", "ఉద్యోగ ఒప్పందాలు", "సేవా కాంట్రాక్టులు", "NDAలు"]
        },
        keySections: [
          { section: "S.10", title: "What agreements are contracts", detail: "Requires free consent, lawful consideration, lawful object, and competent parties." },
          { section: "S.17", title: "Fraud", detail: "Contract induced by fraud is voidable at the option of the deceived party." },
          { section: "S.23", title: "Unlawful consideration", detail: "Contract is void if object is illegal, immoral, or opposed to public policy." },
          { section: "S.27", title: "Restraint of trade", detail: "Post-employment non-compete clauses are largely VOID in India." },
          { section: "S.74", title: "Compensation for breach", detail: "Party can only claim actual losses, not arbitrary penalty amounts." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Business contracts", "Employment agreements", "Service agreements"],
          hi: ["व्यापार अनुबंध", "रोजगार समझौते", "सेवा समझौते"],
          te: ["వ్యాపార కాంట్రాక్టులు", "ఉద్యోగ ఒప్పందాలు", "సేవా ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.7", title: "Arbitration agreement", detail: "Must be in writing to be valid. Oral arbitration agreements are not enforceable." },
          { section: "S.11", title: "Appointment of arbitrators", detail: "Courts can intervene to ensure fairness if one party controls arbitrator selection." },
          { section: "S.34", title: "Setting aside arbitral award", detail: "Awards can be challenged if the arbitration clause itself was invalid or process was unfair." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        keySections: [
          { section: "S.3", title: "Bar of limitation", detail: "Courts shall dismiss suits filed after the limitation period expires." },
          { section: "S.18", title: "Effect of acknowledgement", detail: "Written acknowledgement of a debt restarts the limitation period." },
          { section: "Art.54-55", title: "Contracts limitation", detail: "3 years for most contract disputes from date of breach." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["Builder-buyer agreements", "Apartment purchase contracts", "Real estate developer agreements"],
          hi: ["बिल्डर-खरीदार समझौते", "अपार्टमेंट खरीद अनुबंध", "रियल एस्टेट डेवलपर समझौते"],
          te: ["బిల్డర్-కొనుగోలుదారు ఒప్పందాలు", "అపార్ట్‌మెంట్ కొనుగోలు కాంట్రాక్టులు", "రియల్ ఎస్టేట్ డెవలపర్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.4", title: "Registration of real estate projects", detail: "Builder MUST register project with RERA authority before selling." },
          { section: "S.11", title: "Functions and duties of promoter", detail: "Builder must disclose all project details, deliver possession on time, and maintain the project." },
          { section: "S.18", title: "Return of amount and compensation", detail: "If builder fails to deliver on time, buyer can get full refund + interest (SBI MCLR + 2%)." },
          { section: "S.14", title: "Adherence to approved plans", detail: "Builder cannot change project specifications without buyer consent." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Property sale agreements", "Mortgage deeds", "Lease agreements", "Gift deeds"],
          hi: ["संपत्ति बिक्री समझौते", "बंधक विलेख", "पट्टा समझौते", "उपहार विलेख"],
          te: ["ఆస్తి అమ్మకపు ఒప్పందాలు", "తనఖా దస్తావేజులు", "లీజు ఒప్పందాలు", "బహుమతి దస్తావేజులు"]
        },
        keySections: [
          { section: "S.54", title: "Sale defined", detail: "Transfer of ownership for a price. Must be by registered instrument for immovable property above ₹100." },
          { section: "S.58", title: "Mortgage defined", detail: "Defines types of mortgage — simple, usufructuary, English. Rights differ significantly by type." },
          { section: "S.105", title: "Lease defined", detail: "Leases over 12 months must be registered." },
          { section: "S.108", title: "Rights of lessor and lessee", detail: "Tenant's right to safe premises, landlord's obligation for repairs — cannot be contracted away." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Property sale deeds", "Long-term leases", "Gift deeds", "Mortgage deeds"],
          hi: ["संपत्ति बिक्री विलेख", "दीर्घकालिक पट्टे", "उपहार विलेख", "बंधक विलेख"],
          te: ["ఆస్తి అమ్మకపు దస్తావేజులు", "దీర్ఘకాలిక లీజులు", "బహుమతి దస్తావేజులు", "తనఖా దస్తావేజులు"]
        },
        keySections: [
          { section: "S.17", title: "Documents requiring compulsory registration", detail: "Sale deeds for property above ₹100 and leases exceeding one year MUST be registered." },
          { section: "S.49", title: "Effect of non-registration", detail: "An unregistered document that requires registration cannot be used as evidence in court." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        keySections: [
          { section: "S.3", title: "Equal wages", detail: "No discrimination in wages on grounds of gender for same work." },
          { section: "S.6", title: "Minimum rate of wages", detail: "Every employer must pay wages not less than the floor wage." },
          { section: "S.9", title: "Fixing hours for normal working day", detail: "Normal working day must include intervals for rest — typically 8-9 hours." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        keySections: [
          { section: "S.4", title: "Employment during certain periods prohibited", detail: "No employer shall employ a woman within 6 weeks after delivery or miscarriage." },
          { section: "S.5", title: "Right to maternity benefit", detail: "Every woman is entitled to 26 weeks paid leave at average daily wages." },
          { section: "S.12", title: "Dismissal during absence prohibited", detail: "A woman cannot be dismissed during the period of her maternity benefit." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Employment contracts", "HR policies", "Freelance/gig work agreements"],
          hi: ["रोजगार अनुबंध", "HR नीतियां", "फ्रीलांस/गिग कार्य समझौते"],
          te: ["ఉద్యోగ కాంట్రాక్టులు", "HR విధానాలు", "ఫ్రీలాన్స్/గిగ్ వర్క్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.4", title: "Constitution of ICC", detail: "Every employer with 10+ employees MUST have an ICC. Presiding officer must be a senior woman employee." },
          { section: "S.19", title: "Duties of employer", detail: "Employer must display POSH policy, organise awareness programs, and file annual reports." },
          { section: "S.26", title: "Penalties", detail: "Fine up to ₹50,000 for non-compliance." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Employment contracts", "Labour contracts", "Contractual/gig work agreements"],
          hi: ["रोजगार अनुबंध", "श्रम अनुबंध", "संविदा/गिग कार्य समझौते"],
          te: ["ఉద్యోగ కాంట్రాక్టులు", "కార్మిక కాంట్రాక్టులు", "కాంట్రాక్ట్/గిగ్ వర్క్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.3", title: "Fixing of minimum wages", detail: "State governments fix minimum wages for different scheduled employments." },
          { section: "S.12", title: "Payment of minimum wages", detail: "Employer must pay not less than the minimum wage — any contractual clause paying less is void." },
          { section: "S.22", title: "Penalties", detail: "Up to 6 months imprisonment and/or fine up to ₹500." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["E-commerce terms", "Service agreements", "Product purchase contracts", "App Terms of Service"],
          hi: ["ई-कॉमर्स नियम", "सेवा समझौते", "उत्पाद खरीद अनुबंध", "ऐप सेवा की शर्तें"],
          te: ["ఈ-కామర్స్ నిబంధనలు", "సేవా ఒప్పందాలు", "ఉత్పత్తి కొనుగోలు కాంట్రాక్టులు", "యాప్ సేవా నిబంధనలు"]
        },
        keySections: [
          { section: "S.2(46)", title: "Unfair contract defined", detail: "A contract causing significant imbalance in rights is 'unfair' and the clause can be struck down." },
          { section: "S.10", title: "Central Consumer Protection Authority", detail: "CCPA can investigate unfair trade practices, order product recalls, and penalise false advertising." },
          { section: "S.47", title: "Jurisdiction of District Commission", detail: "Consumers can file complaints for claims up to ₹1 crore at District Commission — no lawyer needed." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Restaurant agreements", "Catering contracts", "Food supply agreements", "Cloud kitchen contracts"],
          hi: ["रेस्तरां समझौते", "कैटरिंग अनुबंध", "खाद्य आपूर्ति समझौते", "क्लाउड किचन अनुबंध"],
          te: ["రెస్టారెంట్ ఒప్పందాలు", "కేటరింగ్ కాంట్రాక్టులు", "ఆహార సరఫరా ఒప్పందాలు", "క్లౌడ్ కిచెన్ కాంట్రాక్టులు"]
        },
        keySections: [
          { section: "S.26", title: "Responsibilities of food business operators", detail: "All food businesses must ensure food is safe. This obligation cannot be contracted away." },
          { section: "S.38", title: "Powers of food safety officer", detail: "Officers can inspect premises, take samples, and seize unsafe food at any time." },
          { section: "S.59", title: "Punishment for unsafe food", detail: "Imprisonment up to 6 months and/or fine up to ₹1 lakh for selling unsafe food." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["App Terms of Service", "Privacy Policies", "Data processing agreements", "E-commerce terms"],
          hi: ["ऐप सेवा की शर्तें", "गोपनीयता नीतियां", "डेटा प्रसंस्करण समझौते", "ई-कॉमर्स नियम"],
          te: ["యాప్ సేవా నిబంధనలు", "గోప్యతా విధానాలు", "డేటా ప్రాసెసింగ్ ఒప్పందాలు", "ఈ-కామర్స్ నిబంధనలు"]
        },
        keySections: [
          { section: "S.6", title: "Consent", detail: "Consent must be free, specific, informed, unconditional, and unambiguous. 'By using this app you agree' is non-compliant." },
          { section: "S.12", title: "Right to correction and erasure", detail: "Data principals can request correction or erasure of personal data at any time." },
          { section: "S.33", title: "Financial penalties", detail: "Up to ₹250 crore per violation." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Online agreements", "E-commerce terms", "Software contracts", "Digital service agreements"],
          hi: ["ऑनलाइन समझौते", "ई-कॉमर्स नियम", "सॉफ्टवेयर अनुबंध", "डिजिटल सेवा समझौते"],
          te: ["ఆన్‌లైన్ ఒప్పందాలు", "ఈ-కామర్స్ నిబంధనలు", "సాఫ్ట్‌వేర్ కాంట్రాక్టులు", "డిజిటల్ సేవా ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.10A", title: "Validity of electronic contracts", detail: "Contracts formed electronically (click-wrap, browse-wrap) are legally valid." },
          { section: "S.43A", title: "Compensation for failure to protect data", detail: "Companies handling sensitive personal data must maintain reasonable security." },
          { section: "S.66", title: "Computer related offences", detail: "Hacking, unauthorized access, data theft — criminal offences with imprisonment up to 3 years." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["All contracts (when fraud is involved)", "Financial agreements", "Property documents"],
          hi: ["सभी अनुबंध (जब धोखाधड़ी शामिल हो)", "वित्तीय समझौते", "संपत्ति दस्तावेज"],
          te: ["అన్ని కాంట్రాక్టులు (మోసం పాల్గొన్నప్పుడు)", "ఆర్థిక ఒప్పందాలు", "ఆస్తి పత్రాలు"]
        },
        keySections: [
          { section: "S.316", title: "Cheating", detail: "Fraudulently inducing someone to sign a contract is a criminal offence — imprisonment up to 3 years." },
          { section: "S.318", title: "Cheating by personation", detail: "Signing as someone else — imprisonment up to 5 years." },
          { section: "S.336", title: "Forgery", detail: "Making a false document — imprisonment up to 2 years." },
          { section: "S.340", title: "Using forged document", detail: "Using a document you know is forged — same punishment as forgery." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Government contracts", "License agreements", "Regulatory approval contracts"],
          hi: ["सरकारी अनुबंध", "लाइसेंस समझौते", "नियामक अनुमोदन अनुबंध"],
          te: ["ప్రభుత్వ కాంట్రాక్టులు", "లైసెన్స్ ఒప్పందాలు", "నియంత్రణ అనుమతి కాంట్రాక్టులు"]
        },
        keySections: [
          { section: "S.7", title: "Offence relating to public servant", detail: "A public servant taking gratification other than legal remuneration is guilty." },
          { section: "S.7A", title: "Taking undue advantage", detail: "Any person giving or taking advantage to influence a public servant is guilty." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["Employment contracts (IP clauses)", "Startup agreements", "Technology transfer agreements"],
          hi: ["रोजगार अनुबंध (IP शर्तें)", "स्टार्टअप समझौते", "प्रौद्योगिकी हस्तांतरण समझौते"],
          te: ["ఉద్యోగ కాంట్రాక్టులు (IP నిబంధనలు)", "స్టార్టప్ ఒప్పందాలు", "సాంకేతిక బదిలీ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.6", title: "Persons entitled to apply for patents", detail: "The true and first inventor or assignee can apply. Employment contracts can assign patent rights to employer." },
          { section: "S.39", title: "Residents not to apply without permission", detail: "Indian residents must get permission before filing patents abroad for inventions made in India." },
          { section: "S.84", title: "Compulsory licence", detail: "After 3 years, anyone can apply for compulsory licence if patented product is not available at affordable price." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Freelance contracts", "Content creation agreements", "Software development contracts", "Publishing agreements"],
          hi: ["फ्रीलांस अनुबंध", "कंटेंट निर्माण समझौते", "सॉफ्टवेयर विकास अनुबंध", "प्रकाशन समझौते"],
          te: ["ఫ్రీలాన్స్ కాంట్రాక్టులు", "కంటెంట్ నిర్మాణ ఒప్పందాలు", "సాఫ్ట్‌వేర్ అభివృద్ధి కాంట్రాక్టులు", "ప్రచురణ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.13", title: "Works in which copyright subsists", detail: "Original literary, dramatic, musical, artistic works, films, and sound recordings are automatically protected." },
          { section: "S.17", title: "First owner of copyright", detail: "The creator is the first owner UNLESS it was created in the course of employment." },
          { section: "S.57", title: "Author's special rights", detail: "Author retains moral rights even after assignment — cannot be waived by contract." },
        ],
        watchFor: {
      ...
      },
      {
        ...
        governs: {
          en: ["Distribution agreements", "Franchise contracts", "Supply contracts", "Licensing agreements"],
          hi: ["वितरण समझौते", "फ्रेंचाइज़ अनुबंध", "आपूर्ति अनुबंध", "लाइसेंसिंग समझौते"],
          te: ["పంపిణీ ఒప్పందాలు", "ఫ్రాంచైజ్ కాంట్రాక్టులు", "సరఫరా కాంట్రాక్టులు", "లైసెన్సింగ్ ఒప్పందాలు"]
        },
        keySections: [
          { section: "S.3", title: "Anti-competitive agreements", detail: "Agreements that fix prices, limit production, share markets, or bid-rig are void." },
          { section: "S.4", title: "Abuse of dominant position", detail: "Dominant companies cannot impose unfair conditions or predatory pricing." },
          { section: "S.27", title: "Penalties", detail: "CCI can impose fines up to 10% of average annual turnover for 3 preceding years." },
        ],
        watchFor: {
    ...
    laws: [
      {
        ...
        governs: {
          en: ["Land purchase agreements", "Industrial leases", "Construction contracts", "Infrastructure contracts"],
          hi: ["भूमि खरीद समझौते", "औद्योगिक पट्टे", "निर्माण अनुबंध", "बुनियादी ढांचे के अनुबंध"],
          te: ["భూమి కొనుగోలు ఒప్పందాలు", "పారిశ్రామిక లీజులు", "నిర్మాణ కాంట్రాక్టులు", "మౌలిక సదుపాయాల కాంట్రాక్టులు"]
        },
        keySections: [
          { section: "S.3", title: "Powers of Central Government", detail: "Government can restrict industries in sensitive areas and set environmental standards — these override contractual rights." },
          { section: "S.5", title: "Power to give directions", detail: "Government can direct closure of any industry — contracts cannot override this." },
          { section: "S.15", title: "Penalties", detail: "Imprisonment up to 5 years and/or fine up to ₹1 lakh. Daily fine of ₹5,000 for continuing violation." },
        ],
        watchFor: {
